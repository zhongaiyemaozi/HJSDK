...
>Target - Deployment Info - Device Orientationq中横竖屏根据需求勾选
...
> Target - Build Phases - Embed Frameworks 选项中引用DynamicLibrary.framework，HJAggregationSDK.framework凉个动态库（或是在Target - General - Embedded Binaries中引入上面三个动态库）
...
>App_Channelld：未提供不更改（默认141），提供了更改成对应的数据



### GameParametersList.plist文件配置无需修改

### mchannelinfos.plist文件配置，未提供的参数无需求改
>以下参数为示例，一切以对应游戏参数为准
>game_id：121
>game_name：逍遥御风诀（IOS版）
>game_appid：73DFD688A47C66F13
>promote_id：0
>promote_account：自然注册
>game_key:jianqijiuzhourg67kf
>Secret_key：DQcAGxkKDQcQFw8IG1RCDhNVWw==
>requestURL：https://998sdk.tlyxgame.com
