...
> Target - Build Phases - Embed Frameworks 选项中引用YouCiFangSDK.framework，HJAggregationSDK.framework二个动态库（或是在Target - General - Embedded Binaries中引入上面二个动态库）
...
### 需要引用头文件#import <YouCiFangSDK/XiFaSDKManager.h>
...
//#pragma mark - 初始化
  //  [[ChannelBridge alloc] initChannel];
