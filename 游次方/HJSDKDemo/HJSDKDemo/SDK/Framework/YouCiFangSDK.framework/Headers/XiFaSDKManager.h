...
#import "XFGameRoleInfo.h"

@interface XiFaSDKManager : NSObject

/**
 * 单例
 */
+ (XiFaSDKManager*)share6lsdk;
 ...
 */
+ (void)initializeXiFaSDKWithAppId:(NSString *)appId
 ...
 * 角色上报
 */
+ (void)sendXFGameRoleInfo:(XFGameRoleInfo*)roleInfo;
 ...
 */
+ (void)addXFAssistiveView:(UIView *)view;
